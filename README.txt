# Re# Reinforcement Learning for Open Face Chinese Poker
...
- OpenAI Gym
- TensorFlow team
```in# Reinforcement Learning for Open Face Chinese Poker
...
- OpenAI Gym
- TensorFlow team
```forcement Learning for Open Face Chinese Poker
